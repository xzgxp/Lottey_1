...
public class Fivedirectsingle extends BaseFragmentticket implements OnClickListener {
	...
	public void onResume() {
		...
		BaseActivityticket.curFragmentTag = getString(R.string.five_direct_single_name);
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View context = inflater.inflate(R.layout.ticket_five_direct_single, container, false);
	...
	private String splitstring(String str) {
		...
		for (int i = 0; i < temp.length; i++) {
			if (temp[i].length() == 10) {
				...
				temp[i] = tempsingle[0] + tempsingle[1] + tempsingle[2] + tempsingle[3] + tempsingle[4] + tempsingle[5]
						+ " " + tempsingle[6] + tempsingle[7] + tempsingle[8] + tempsingle[9] + tempsingle[10];
			}
			result = result + temp[i] + " ";
		}
		return result;
