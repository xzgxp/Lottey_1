...
public class Bottompthreemixgroup extends BaseFragmentticket implements OnClickListener {
	...
	public void onResume() {
		...
		BaseActivityticket.curFragmentTag = getString(R.string.bottompthree_mix_group_name);
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View context = inflater.inflate(R.layout.ticket_bottompthree_mix_group, container, false);
	...
	private String clearother(String s) {
		...
		for (int i = 0; i < temp.length; i++) {
			if ((temp[i].equals("0") || temp[i].equals("1") || temp[i].equals("2") || temp[i].equals("3")
					...
					|| temp[i].equals(";") || temp[i].equals(",") || temp[i].equals("；")
	...
	private TextWatcher textWatcher = new TextWatcher() {
		...
		public void onTextChanged(CharSequence s, int start, int before, int count) {
			...
			result = clearother(edit_text);result = splitstring(result);
			Log.e("result", result);
