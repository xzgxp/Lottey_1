...
public class Bottompthreegroupthreesingle extends BaseFragmentticket implements OnClickListener {
	...
	public void onResume() {
		...
		BaseActivityticket.curFragmentTag = getString(R.string.bottompthree_group_three_single_name);
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View context = inflater.inflate(R.layout.ticket_bottompthree_group_three_single, container, false);
		...
		for (int i = 0; i < temp.length; i++) {
			...
			if (temp[i].length() == 4) { // 判断是否有字符重复
				...
				if ((tmp0.equals(tmp1) && tmp0.equals(tmp2))
						|| (!tmp0.equals(tmp1) && !tmp0.equals(tmp2) && !tmp1.equals(tmp2))) {
					temp[i] = "";
				}
