...
public class Fourdirectsingle extends BaseFragmentticket implements OnClickListener {
	...
	public void onResume() {
		...
		BaseActivityticket.curFragmentTag = getString(R.string.four_direct_single_name);
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View context = inflater.inflate(R.layout.ticket_four_direct_single, container, false);
		...
		for (int i = 0; i < temp.length; i++) {
			if (temp[i].length() == 8) {
				...
				temp[i] = tempsingle[0] + tempsingle[1] + tempsingle[2] + tempsingle[3] + tempsingle[4] + " "
						+ tempsingle[5] + tempsingle[6] + tempsingle[7] + tempsingle[8];
			}
			result = result + temp[i] + " ";
		}
		return result;
