 ...
 *
 */
public class TabAFragment extends Fragment implements OnTouchListener {
	private recondadapter mAdapter;
	private ListView list_tab_a;
	private LinearLayout swipe_container;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		// go();
		swipe_container = (LinearLayout) view.findViewById(R.id.swipe_container);
		...
		list_tab_a.setOnTouchListener(this);
		list_tab_a.setOnScrollListener(new AbsListView.OnScrollListener() {
	...
	private List<recondmodel> getData() {
		...
		for (int i = 0; i < length; i++) {
			...
			orderinfo.setTicketContent(ticketContent[i]);
			orderinfo.setTicketOrderNo(ticketOrderNo[i]);
			list.add(orderinfo);
	...
	public void getnew() {
		...
		new AsyncTask<Void, Void, String>() {
			...
			protected String doInBackground(Void... params) {
				...
				HttpPost httpPost = new HttpPost("http://lottery1.cftb58.cn/App/GetTouzhuList");
