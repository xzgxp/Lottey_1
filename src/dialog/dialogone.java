...
public class dialogone extends Dialog {
	...
	public static class Builder {
		...
		private BaseActivityticket BaseActivityticket;
		...
		public dialogone create() {
			LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			// instantiate the dialog with the custom Theme
			final dialogone dialog = new dialogone(context, R.style.Dialog);
			final View layout = inflater.inflate(R.layout.dialog_one, null);
