...
public class threed extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		text_gotouzhu.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(threed.this, threeDBaseActivityticket.class);
	...
	protected void go() {
		...
		threedlist.setAdapter(mAdapter);
	...
	public void getnew() {
		...
		nameValuePairs.add(new BasicNameValuePair("game", "福彩3D"));
