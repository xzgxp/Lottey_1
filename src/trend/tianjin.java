...
public class tianjin extends Activity {
	private LinearLayout lin_loading;
	private trendadapter mAdapter;
	private ListView tianjinlist;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		text_gotouzhu.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(tianjin.this, BaseActivityticket.class);
	...
	protected void go() {
		...
		tianjinlist.setAdapter(mAdapter);
	...
	public void getnew() {
		...
		nameValuePairs.add(new BasicNameValuePair("game", "天津"));
