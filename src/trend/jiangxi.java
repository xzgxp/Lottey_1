...
public class jiangxi extends Activity {
	private LinearLayout lin_loading;
	private trendadapter mAdapter;
	private ListView jiangxilist;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		text_gotouzhu.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(jiangxi.this, BaseActivityticket.class);
	...
	protected void go() {
		...
		jiangxilist.setAdapter(mAdapter);
	...
	public void getnew() {
		...
		nameValuePairs.add(new BasicNameValuePair("game", "江西"));
