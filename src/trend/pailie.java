...
import adapter.trendthreedadapter;
...
public class pailie extends Activity {
	private LinearLayout lin_loading;
	private trendthreedadapter mAdapter;
	private ListView pailielist;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		text_gotouzhu.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(pailie.this, threeDBaseActivityticket.class);
	...
	protected void go() {
		...
		mAdapter = new trendthreedadapter(this, getData());
		pailielist.setAdapter(mAdapter);
	...
	public void getnew() {
		...
		nameValuePairs.add(new BasicNameValuePair("GameGroup", "dipin"));
		nameValuePairs.add(new BasicNameValuePair("game", "排列三"));
