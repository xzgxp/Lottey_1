...
public class xinjiang extends Activity {
	private LinearLayout lin_loading;
	private trendadapter mAdapter;
	private ListView xinjianglist;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		text_gotouzhu.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(xinjiang.this, BaseActivityticket.class);
	...
	protected void go() {
		...
		xinjianglist.setAdapter(mAdapter);
	...
	public void getnew() {
		...
		nameValuePairs.add(new BasicNameValuePair("game", "新疆"));
