	...
	public void onClick(View v) {
		...
		case R.id.Lin_ok:
			...
			if (nowpassword.equals("")) {
				Toast.makeText(paypassword.this, "请输入当前密码", Toast.LENGTH_SHORT).show();
			} else if (newpassword.equals("")) {
				Toast.makeText(paypassword.this, "请输入新密码", Toast.LENGTH_SHORT).show();
			} else if (newpasswordagain.equals("")) {
				Toast.makeText(paypassword.this, "请确认新密码", Toast.LENGTH_SHORT).show();
			} else if (!newpassword.equals(newpasswordagain)) {
				Toast.makeText(paypassword.this, "两次输入不一致", Toast.LENGTH_SHORT).show();
			} else {
				if (ifok == 0) {
					ifok = 1;
					...
					Toast.makeText(paypassword.this, "已提交", Toast.LENGTH_SHORT).show();
				} else {
					Toast.makeText(paypassword.this, "不要重复点击", Toast.LENGTH_SHORT).show();
				}
			}
	...
	private void getchange(String password, String newpassword) {
		...
		new AsyncTask<Void, Void, String>() {
			...
			protected String doInBackground(Void... params) {
				...
				Log.d("xxxxx", "1");
				HttpPost httpPost = new HttpPost("http://lottery1.cftb58.cn/App/ChangePayPassword");
				Log.d("xxxxx", "11");
